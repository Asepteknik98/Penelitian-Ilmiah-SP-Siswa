...
<head>
    ...
    <meta name="description" content="website Sistem Pakar Bidang Vokasi">
...
<body class="text-center">
    <form class="form-signin" action="proseslogin.php" method="POST">
      <a href="index.php"><img class="mb-4" src="image/uca1.png" alt="" width="72" height="72"></a>
      ...
      <p class="mt-5 mb-3 text-muted">Asep Setiadi &copy; 2024</p>
    </form>
  </body>
</html>